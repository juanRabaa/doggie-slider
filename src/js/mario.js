...
// Made with Zdog
export default function makeMarioModel({ elem }) {
  // var illoSize = 72
  // var minWindowSize = Math.min(elem.innerWidth - 20, elem.innerHeight - 60)
  // var zoom = Math.floor(minWindowSize / illoSize)
  // elem.setAttribute('width', illoSize * zoom)
  // elem.setAttribute('height', illoSize * zoom)
